...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    $sql = 'INSERT INTO usuarios (Nombre, Apellido, Cedula, Fecha_De_Nacimiento, Correo, Contrasenia, Telefono, Genero, Rol) VALUES (:nombre, :apellido, :cedula, :fecha_nacimiento, :correo, :contrasena, :telefono, :genero, :rol)';
